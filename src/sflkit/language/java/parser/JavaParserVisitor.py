...
class JavaParserVisitor(ParseTreeVisitor):
    ...
    def visitInterfaceCommonBodyDeclaration(
    ...
    def visitPostIncrementDecrementOperatorExpression(
    ...
    def visitBinaryOperatorExpression(
    ...
    def visitSquareBracketExpression(
